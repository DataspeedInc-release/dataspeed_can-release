## dataspeed_can (lyrical) - 2.0.8-1

The packages in the `dataspeed_can` repository were released into the `lyrical` distro by running `/usr/bin/bloom-release --ros-distro lyrical dataspeed_can` on `Wed, 23 Sep 2026 13:44:32 -0000`
...
## dataspeed_can (jazzy) - 2.0.8-1

The packages in the `dataspeed_can` repository were released into the `jazzy` distro by running `/usr/bin/bloom-release --ros-distro jazzy dataspeed_can` on `Wed, 23 Sep 2026 13:41:43 -0000`
...
## dataspeed_can (lyrical) - 2.0.7-1

The packages in the `dataspeed_can` repository were released into the `lyrical` distro by running `/usr/bin/bloom-release --ros-distro lyrical dataspeed_can` on `Tue, 09 Jun 2026 20:23:32 -0000`
...
## dataspeed_can (jazzy) - 2.0.7-1

The packages in the `dataspeed_can` repository were released into the `jazzy` distro by running `/usr/bin/bloom-release --ros-distro jazzy dataspeed_can` on `Tue, 09 Jun 2026 20:17:34 -0000`
...
## dataspeed_can (humble) - 2.0.6-1

The packages in the `dataspeed_can` repository were released into the `humble` distro by running `/usr/bin/bloom-release --ros-distro humble dataspeed_can` on `Wed, 12 Mar 2025 13:59:33 -0000`
...
The packages in the `dataspeed_can` repository were released into the `humble` distro by running `/usr/bin/bloom-release dataspeed_can --rosdistro humble` on `Mon, 16 Dec 2024 17:38:00 -0000`
